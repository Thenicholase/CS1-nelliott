...
int main(int argc, char* argv[]) {
    ...
    big_int *dif = new large_int;
    large_int *larger = new large_int; //FIXED3
    ...
    switch (oper) {
        ...
        case SUBTRACT:
            ...
            cin >> *num1 >> *num2;
            *dif = MyFunctions::findDifference(*num1, *num2);
            printf("%lld - %lld = %lld\n", *num1, *num2, *dif);
            break;
        case LARGER:
            cout << "Enter two whole numbers seperated by a space: ";
            ...
            *larger = MyFunctions::findLarger(num1, num2);
            printf("Between %lld & %lld the larger number is %lld\n", *num1, *num2, *larger);
            break; //FIXED6
...
big_int MyFunctions::findLarger(const big_int *num1, const big_int *num2) {
    if(*num1>*num2){
        return *num1;
    } else {
        return *num2;
