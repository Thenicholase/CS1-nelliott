...
void test() {
   ...
   double answer2 = findDifference(15, 10);
   double expected2 = 5;
   assert(answer2 == expected2);
   assert(findDifference(35,20) == 15);

   double answer3 = findProduct(6,3);
   double expected3 = 18;
   assert(answer3 == expected3);
   assert(findProduct(12,10) == 120);

   double answer4 = findLarger(120, 11);
   double expected4 = 120;
   assert(answer4 == expected4);
   assert(findLarger(35,72) == 72);

   double answer5 = findSmaller(17,3);
   double expected5 = 3;
   assert(answer5 == expected5);
   assert(findSmaller(27,36) == 27);

   double answer6 = findQuotient(24,2);
   double expected6 = 12;
   assert(answer6 == expected6);
   assert(findQuotient(100,5) == 20);

   double answer7 = findAverage(10,20);
   double expected7 = 15;
   assert(answer7 == expected7);
   assert(findAverage(50,100) == 75); //#FIXED9
...
bool program() {
    ...
    switch(option) {
        ...
        case 2:
        {
            ...
            double difference = findDifference(num1, num2); //#FIXED10
            printf("%.2f - %.2f = %.2f\n", num1, num2, difference); //#FIXED11
